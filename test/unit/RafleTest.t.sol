...
contract RaffleTest is Test {
    ...
    function testCheckupReturnsFalseIfRaffleIsClosed() public {
        // Arrange
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
        vm.warp(block.timestamp + interval + 1);
    ...
    //// performUpkeep                    ///
    /////////////////////////////////////////
    function testPerformUpkeepCanOnlyRunWhenCheckUpkeepReturnsTrue() public {
        // Arrange
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
        vm.warp(block.timestamp + interval + 1);
        ...
        skipFork
    {
        ...
        // Pretend to be a chainlink vrf so as to get some random numbers and pick a winner
        VRFCoordinatorV2Mock(vrfCoordinator).fulfillRandomWords(
            uint256(requestId),
            address(raffle)
        );
